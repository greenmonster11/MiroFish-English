...
class ZepToolsService:
    ...
    def _generate_sub_queries(
        ...
        """
        system_prompt = """You are a professional question analysis expert. Your task is to decompose a complex question into multiple sub-questions that can be independently observed in a simulated world. Always respond in English.
...
Return the list of sub-questions in JSON format."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios requiring understanding of the full event picture and tracking evolution processes.
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "to directly answer the following questions in plain text. Always respond in English.\n"
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean up JSON tool call wrapping in agent responses and extract actual content"""
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Your task is to select the most suitable interviewees from a list of simulated agents based on interview requirements. Always respond in English.
...
Please select up to {max_agents} agents most suitable for interviewing, and explain the selection reasoning."""
    ...
    def _generate_interview_questions(
        ...
        system_prompt = """You are a professional journalist/interviewer. Generate 3-5 in-depth interview questions based on the interview requirements. Always respond in English.
...
Please generate 3-5 interview questions."""
    ...
    def _generate_interview_summary(
        ...
        system_prompt = """You are a professional news editor. Please generate an interview summary based on the responses from multiple interviewees. Always respond in English.

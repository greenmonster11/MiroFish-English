...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If a node's labels contain only "Entity", it does not match any predefined type -- skip
        - If a node's labels include labels other than "Entity" and "Node", it matches a predefined type -- keep

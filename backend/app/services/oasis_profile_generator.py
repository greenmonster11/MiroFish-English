...
class OasisProfileGenerator:
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        searched separately and the results merged. Parallel requests are used to
        improve efficiency.
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are an expert in social media user profile generation. Generate detailed, realistic personas for public opinion simulation, faithfully reproducing known real-world conditions. You must return valid JSON format, and all string values must not contain unescaped newline characters. Always respond in English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, faithfully reproducing known real-world conditions.
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for this institutional/group entity, faithfully reproducing known real-world conditions.
...
2. persona: Detailed account profile description (2000 words of plain text), must include:
   - Institutional basic information (official name, organizational nature, founding background, main functions)
...
- gender field must be the English string "other"
...
- Institutional account communications must be consistent with its identity and positioning"""
    ...
    def save_profiles(
        ...
        """
        Save profiles to file (selecting correct format based on platform)
    ...
    def _normalize_gender(self, gender: Optional[str]) -> str:
        ...
        # Gender mapping (includes Chinese keys for backward compatibility)
        gender_map = {
            "\u7537": "male",       # Chinese: male

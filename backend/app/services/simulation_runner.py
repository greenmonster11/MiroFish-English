...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Create main log file to avoid process blocking due to stdout/stderr pipe buffer being full
            ...
            # Set working directory to simulation directory (database and other files are generated here)
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this env var doesn't exist, and registration is still needed
    ...
    def close_simulation_env(
        ...
        Send close environment command to the simulation, allowing it to gracefully exit command-waiting mode

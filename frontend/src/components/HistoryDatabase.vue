...
const getCardStyle = (index) => {
  ...
  if (isExpanded.value) {
    ...
    const x = offset * 35
    // Adjust starting position, close to the title but with proper spacing
...
.grid-pattern {
  ...
  /* Position from top-left so height changes only expand at the bottom without affecting existing grid positions */
